...
- **Harness teardown** — `spike-ext/` and `web/spike/` were deliberately retained during M8a implementation for use as a debug tool, then deleted by the teardown PR that followed PR #33, well ahead of any promotion to `main`.
