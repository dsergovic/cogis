...
export default {
  ...
  platforms: {
    ...
    claude: {
      ...
      pageSize: 20,
      notes:
        'Endpoint-first per S2: GET organizations → paginated chat_conversations (client title-match) → Projects directory + per-project conversations. Deep link https://claude.ai/chat/{uuid}. Prefill not supported. Capability title-match. DOM Recents selectors are auth/fallback hints only.',
    },
  },
};
